...
export default async function AuthLayout({
  ...
  const branding = {
    institutionName: tenantSlug
      ? `${tenantSlug.toUpperCase()} LMS`
      : "SuperAdmin Portal",
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center p-8 bg-slate-50 dark:bg-slate-950">
