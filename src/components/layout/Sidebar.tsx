  ...
  return (
    <ShadcnSidebar collapsible="icon">
      <SidebarHeader className="flex h-16 shrink-0 items-center justify-center px-4 border-b border-slate-200 dark:border-slate-800">
        <Link href="/" className="flex items-center gap-2 font-bold text-xl text-blue-600 dark:text-blue-400 overflow-hidden">
          <Mountain className="w-6 h-6 shrink-0" />
          <span className="truncate group-data-[collapsible=icon]:hidden">LMS Portal</span>
        </Link>
      </SidebarHeader>
                  ...
                  return (
                    <SidebarMenuItem key={item.href}>
                      <SidebarMenuButton 
                        ...
                        className={cn(
                          "transition-colors",
                          isActive && "bg-slate-200 dark:bg-slate-800 text-slate-900 dark:text-slate-50"
                        )}
                      >
